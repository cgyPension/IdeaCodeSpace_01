package com.atguigu.SparkCore.req.service


import com.atguigu.SparkCore.req.bean.HotCategory
import com.atguigu.SparkCore.req.dao.HotCategoryAnalysisTop10Dao
import com.atguigu.SparkCore.req.helper.HotCategoryAccumulator
...
class HotCategoryAnalysisTop10Service extends TService{
    ...
    override def analysis() = {
        ...
        // TODO 读取电商日志数据
        val actionRDD: RDD[String] = hotCategoryAnalysisTop10Dao.readFile("MySpark/input/user_visit_action.txt")
