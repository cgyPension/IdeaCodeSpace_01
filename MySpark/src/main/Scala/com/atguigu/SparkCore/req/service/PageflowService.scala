...
import com.atguigu.SparkCore.req.dao.PageflowDao
...
class PageflowService extends TService {
    ...
    override def analysis() = {
        ...
        // TODO 在实际开发情况中，我们只需要一些指定的页面流转率。对指定的页面流程进行页面单跳转换率的统计
        // 1，2，3，4，5，6，7
        ...
        val actionRDD: RDD[bean.UserVisitAction] =
            pageflowDao.getUserVisitAction("MySpark/input/user_visit_action.txt")
        actionRDD.cache()
