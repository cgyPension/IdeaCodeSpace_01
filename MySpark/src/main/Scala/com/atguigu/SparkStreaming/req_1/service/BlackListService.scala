...
import com.atguigu.SparkStreaming.req_1.bean.Ad_Click_Log
import com.atguigu.SparkStreaming.req_1.dao.BlackListDao
          ...
          datas => {
            ...
            val pstat1 = conn.prepareStatement(
              """
                ...
                |     userid
                | from user_ad_count
                | where  DATE_FORMAT(dt,'%Y-%m-%d') = ? and userid = ? and adid = ? and count >= 100
                            """.stripMargin)
